...
export default function Hero() {
  return (
    <div className="text-center mb-[79px]">
      <p className="text-4xl md:text-5xl font-bold mt-[79px]">Safezone</p>
      <p className="mt-1.5 text-l md:text-xl mb-[79px]">
        Creating a sage environent for everyone
      </p>
      <div className="relative">
        <div className="container px-4 absolute bottom-0 mx-auto md:text-right flex flex-col mb-[48px] ">
          <p className="text-4xl md:text-5xl font-bold">Mission</p>
          <p className="mt-14 text-[16px] md:text-lg max-w-[644px] self-end">
