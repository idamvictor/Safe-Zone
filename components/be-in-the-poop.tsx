      ...
      <div className=" flex flex-col items-center mb-0 w-full max-w-[1072px] max-md:mb-2.5 max-md:max-w-full">
        ...
        <div className="flex flex-wrap justify-center gap-10 items-center mt-16 w-full max-md:mt-10 max-md:max-w-full">
          <Image
            ...
            alt=""
            className="intersect:motion-preset-slide-right motion-duration-1500 motion-ease-spring-bouncier my-auto rounded-2xl aspect-[0.45] min-w-[240px] shadow-[14px_14px_58px_rgba(0,0,0,0.18)] w-[223px]"
            width={278}
            height={522}
          />
          <div className="intersect:motion-preset-slide-left motion-duration-1500 motion-ease-spring-bouncier flex flex-col grow shrink self-stretch my-auto min-w-[240px] w-[527px] max-md:max-w-full">
