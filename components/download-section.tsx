...
export const DownloadSection: React.FC = () => {
  return (
    <div className="flex overflow-hidden flex-col justify-center items-center px-20 py-36 w-full border-b-0 bg-secondary border-secondary-foreground max-md:px-5 max-md:py-24 max-md:max-w-full">
      <div className="flex flex-col justify-center mb-0 max-w-full w-[612px] max-md:mb-2.5">
        ...
        <div className="flex gap-6 items-center self-center mt-12 max-w-full w-[461px] max-md:mt-10">
